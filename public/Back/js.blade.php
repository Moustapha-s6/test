  ...
  <script src="{{asset('Back/assets/plugins/apexcharts-bundle/js/apexcharts.min.js')}}"></script>
  <script src="{{asset('Back/assets/plugins/chartjs/chart.min.js')}}"></script>
  ...
  <script src="{{asset('Back/assets/js/main.js')}}"></script>
    ...
    <script src="{{asset('Back/assets/js/table-datatable.js')}}"></script>